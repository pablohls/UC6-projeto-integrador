...
df = pd.read_csv(r'C:\Users\Técnico em IA\PycharmProjects\PythonProject\60635000_Cotas.csv', encoding='latin1', header=11, sep = ";")
...
colunas = (['NivelConsistencia', 'MediaDiaria', 'TipoMedicaoCotas', 'Maxima', 'Minima', 'Media', 'DiaMaxima', 'DiaMinima', 'MediaAnual'])
...
#print(colunas_cota)
df = df.melt(id_vars=['EstacaoCodigo','Data', 'hora'], value_vars=colunas_cota,
        var_name='Dia', value_name='Cota')
